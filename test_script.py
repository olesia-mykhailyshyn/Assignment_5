...
def test_echo():
    tests = [
        ...
        {"input": "max(max(2, 3), min(4, 5))\n", "expected_output": "5.000000"},
        {"input": "min(max(min(5, 3), 2), max(4, 6))\n", "expected_output": "3.000000"},
        {"input": "max(2, 3) + min(4, 5)\n", "expected_output": "7.000000"},
        {"input": "abs(max(2, -3)) * min(4, 5)\n", "expected_output": "8.000000"},
        {"input": "max(2, 3) + abs(min(4, -5))\n", "expected_output": "8.000000"},
        {"input": "min(max(2, 3), 4) - 5\n", "expected_output": "-1.000000"},
        {"input": "min(max(2, 3), 4) / 2\n", "expected_output": "1.500000"},
        {"input": "max(2, 3) + min(4, 5) * 2\n", "expected_output": "11.000000"},
        {"input": "min(2, 3) - max(4, 5) / 2\n", "expected_output": "-0.500000"},
        {"input": "abs(max(2, -3)) * min(4, 5) ^ 2\n", "expected_output": "32.000000"},
        {"input": "max(2, 3) / min(4, 5) + 2\n", "expected_output": "2.750000"},
        {"input": "min(2, 3) ^ max(4, 5) - 1\n", "expected_output": "31.000000"},
        # Function calls
